    ...
    <div class="container-fluid p-0">
        ...
        <footer class="footer bg-dark text-white mt-5">
            <div class="container py-5">
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="footer-section-title">About Modimal</h5>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#" class="text-white text-decoration-none">Support System</a></li>
                            <li><a href="#" class="text-white text-decoration-none">Terms & Condition</a></li>
                            <li><a href="#" class="text-white text-decoration-none">Copyright Notice</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <h5 class="footer-section-title">Help & Support</h5>
                        <ul class="list-unstyled">
                            <li><a href="#" class="text-white text-decoration-none">Orders & Shipping</a></li>
                    ...
                    <div class="col-md-4">
                        <h5 class="footer-join-title">Join Up</h5>
                        <ul class="list-unstyled">
                            <li><a href="#" class="text-white text-decoration-none">Modimal Club</a></li>
                            <li><a href="#" class="text-white text-decoration-none">Careers</a></li>
                            <li><a href="#" class="text-white text-decoration-none">Visit Us</a></li>
                        </ul>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-6">
                        <h5 class="mb-3">Join Our Club, Get 15% Off For Your Birthday</h5>
            ...
            <div class="container-fluid bg-dark py-3">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <p class="mb-0">&copy; 2023 Modimal. All Rights Reserved.</p>
                    </div>
