        ...
        <div class="mega-menu bg-white shadow" id="aboutMegaMenu">
            <div class="container py-4 d-flex">
                ...
                <div class="navbar-functions d-flex gap-3">
                    ...
                    ?>
                        <span class="user-icon material-symbols-rounded" id="userIcon">account_circle</span>
                        <a href="/views/pages/customerinfo.php" class="text-dark text-decoration-none">
                        <span class="a" id="userIcon">
                        </span>
